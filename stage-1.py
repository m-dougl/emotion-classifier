...
#dataset analysis
emotions_count=df_labels.value_counts()
plot=emotions_count.plot(kind='bar', title='Emotions present in DataFrame', legend=True,colormap='summer',fontsize=10)
...
emotions_percentage=df_labels.value_counts(normalize=True)
plt.figure(figsize=(10,7))
emotions_percentage.plot(kind='pie', title='Emotion percentage', autopct='%.0f%%', colormap='summer',fontsize=10,legend=True)
plt.axis('off')
plt.show()

# First stage is classification without pre-processing methods
